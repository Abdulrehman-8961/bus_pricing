    ...
    <div class="container-fluid mw-100">
        <div class="card w-100 position-relative overflow-hidden">
            <div class="card-body p-4">
                <form method="POST" class="container-fluid" action="{{ url('/Bus-Type/Update/'.$row->id) }}">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-12">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('capacity') is-invalid @enderror" name="capacity" id="capacity"
                                    value="{{ $row->capacity }}">
                                @error('capacity')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-lg-3 col-12 ">
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control @error('city_transfer') is-invalid @enderror"
                                    name="city_transfer" id="city_transfer" value="{{ $row->city_transfer }}">
                                @error('city_transfer')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-3 col-12 ">
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control @error('one_way_transfer') is-invalid @enderror"
                                    name="one_way_transfer" id="one_way_transfer" value="{{ $row->one_way_transfer }}">
                        ...
                        <div class="col-lg-3 col-12">
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control @error('short_usage') is-invalid @enderror" name="short_usage" id="short_usage"
                                    value="{{ $row->short_usage }}">
                                @error('short_usage')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-3 col-12">
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control @error('half_day_trip') is-invalid @enderror" name="half_day_trip" id="half_day_trip"
                                    value="{{ $row->half_day_trip }}">
                                @error('half_day_trip')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-3 col-12">
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control @error('full_day_trip') is-invalid @enderror" name="full_day_trip" id="full_day_trip"
                                    value="{{ $row->full_day_trip }}">
                                @error('full_day_trip')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-3 col-12">
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control @error('max') is-invalid @enderror"
                                    value="{{ $row->max }}" name="max" id="max" step="0.01">
                                @error('max')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-12">
                                        <div class="mb-4">
                                            ...
                                            <input type="number"
                                                class="form-control @error('kilometers') is-invalid @enderror" name="kilometers[]" id="kilometers" value="{{ $value->kilometers }}">
                                            @error('kilometers')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-3 col-12">
                                        <div class="mb-4">
                                            ...
                                            <input type="number"
                                                class="form-control @error('price') is-invalid @enderror" name="price[]" id="price" value="{{ $value->price }}"
                                                step="0.01">
                                            @error('price')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
